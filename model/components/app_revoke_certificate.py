...
class AppRevokeCertificate(BaseDriver):
    _page_url = 'base_url/profile/space/app/app_id/certs'

    _REVOKE_CERT = 'div.certificatesItems > div > div > div.cert__action.action__revoke.certificatesItem__action'
    ...
    _EDIT_REVOKE_CERT = 'div.confirmation-page__btn-block > input.btn'
    _NEW_CERT_BTN = '.btn__secondary-sm'
    _MASSAGES_WRAPPER = 'div.messages-wrapper > div:nth-child(1) > .visually-hidden'
